      ...
      <aside className="sidebar">
        ...
        <nav className="nav-menu sidebar-menu">
          ...
          {/* <NavLink to="#sales-report" className="nav-link">
                                <img
                                    loading="lazy"
                                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/8baf0b144fc8c1c7bf30eddb4ed0e8f6632bca9df885056a8a01bc366ab65643?apiKey=25b957d3db53419f881a9efe72b830ae&"
                                    className="icon"
                                    alt="Icon"
                                />
