...
//     const username = event.target.customUsername.value;
//     const password = event.target.customPassword.value;

//     if (username === "user" && password === "pass") {
//       alert("Login successful!");
//       window.location.href = "userdashboard-overview.html";
//     } else {
...
//   const handleSendOtp = () => {
//     const mobile = document.getElementById("customMobile").value;
